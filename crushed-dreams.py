...
c1 >> blip(((0,2,4,6) + var([0,3],[24,8])) % 7, dur=8, sus=2, echo=0.75, decay=8, lpf=3000, lpr=0.2, room=0.25).spread()
p1 >> sinepad([0,4,[6,[8,9]],7], dur=1/2, sus=1, drive=0.1, room=1, lpf=expvar([20,2000],32)).sometimes("rotate") + var([0,2],[12,4])
